...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoib2NoYW5pc3NpIiwiYSI6ImNrM3lycWVmMzBvMHAzbHA2NWw4MHF5OWoifQ.jUok_FWVOlBb_7866W6pyA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/ochanissi/ck3yrv7ik0hij1cnz20qas2x6',
    scrollZoom: false //   center: [25.781842, -80.128473],
    //   zoom: 10,
    //   interactive: false
...
/* eslint-disable */
var updateDate = function updateDate(name, email) {
  var res;
  return regeneratorRuntime.async(function updateDate$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
...
var userDataForm = docuent.querySelector('.form-user-data'); // DELEGATION
